// Queries
/* 
1.  Need to ask about mobild number validation method - done
2.  Need to ask about partner type validation method - done
3.  partnerProgramForm() -> above two validation needs to be added ? - done
4.  Need to ask about company name validation
5.  Need to ask about product validation
6.  Request a meeting api url ?
*/
    ...
    try {
        ...
        if (returnType) {
            ...
            let reqPayload = {
                ...
                "Lastname": lastNameInput.value,
                EmailID: emailInput.value,
                MobileNumber: mobileNoGlob.value,
                Country: selectSubCountry.value,
                Industry: selectIndustryInput.value,
                "Jobtitle": selectJobTitle.value,
                checkbox: "on",
