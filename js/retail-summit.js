...
function requestStrategyForm(event) {
    ...
    // Validate First Name
    if (firstName == "") {
        document.getElementById('error_firstname').innerHTML = "Enter full name";
