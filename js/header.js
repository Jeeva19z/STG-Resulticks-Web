...
var resulticksHeader = `
// <nav class="navbar fixed-top white-theme navbar-expand-lg animated navigation" id="rs-header">
...
//     </nav>
    ...
    <nav class="navbar fixed-top white-theme navbar-expand-lg animated navigation flex-column" id="rs-header" >
